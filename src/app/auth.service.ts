...
export class AuthService {
  ...
  private _addiprocurementUrl = "http://localhost:3001/user/addiprocurement";
  ...
  private _profiledetailsUrl = "https://hrmsbackend.herokuapp.com/user/editprofiledetails";
